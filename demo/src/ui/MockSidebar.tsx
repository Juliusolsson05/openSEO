...
/* ────────────────────────────────────────────
 * Static replica of the Aurora dashboard sidebar.
 * Dark panel (240px) with navigation sections,
 * matching the real sidebar.tsx layout exactly.
 * ──────────────────────────────────────────── */

/** Aurora "A" logo — white version for dark sidebar */
...
/* Simple icon components replicating lucide icons at 16px */
const IconFileText = () => (
...
const sections: NavSection[] = [
  {
    heading: "CONTENT",
    items: [
      { label: "Blog Posts", icon: <IconFileText /> },
      { label: "Titles", icon: <IconHeading />, active: true },
      { label: "Scheduling", icon: <IconCalendar /> },
      { label: "Call to Actions", icon: <IconTarget /> },
    ],
  },
  {
    heading: "INSIGHTS",
    items: [{ label: "Analytics", icon: <IconBarChart /> }],
  },
  {
    heading: "EXTENSIONS",
    items: [
      { label: "Elements", icon: <IconLayers /> },
      { label: "Dictionaries", icon: <IconBook /> },
    ],
  },
  {
    heading: "SETTINGS",
    items: [
      { label: "Company Profile", icon: <IconBuilding /> },
      { label: "Settings", icon: <IconSettings /> },
      { label: "Publishing", icon: <IconUpload /> },
    ],
  },
];
...
export const MockSidebar: React.FC = () => (
  ...
  >
    ...
    >
      ...
      <span style={{ fontSize: 15, fontWeight: 600, color: "#FFFFFF", letterSpacing: "-0.01em", fontFamily: F }}>
        Aurora
      </span>
    </div>
          ...
          {section.items.map((item, ii) => (
            <div
              ...
              style={{
                ...
                padding: "7px 16px",
                fontSize: 13,
                color: item.active ? "#FFFFFF" : COLORS.sidebarForeground,
                background: item.active ? COLORS.sidebarAccent : "transparent",
                fontFamily: F,
              }}
            >
              {/* Left accent bar */}
