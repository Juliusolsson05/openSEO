...
interface TimelineProps extends Omit<ElementComponentProps, 'content'> {
  content: TimelineContent
}

export function Timeline({ content, blogId, elementId, onContentUpdated, onElementDeleted }: TimelineProps) {
  return (
    <BaseElement
      content={content}
      blogId={blogId}
