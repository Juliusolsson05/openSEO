...
interface ProsAndConsProps extends Omit<ElementComponentProps, 'content'> {
  content: ProsAndConsContent
}

export function ProsAndCons({ content, blogId, elementId, onContentUpdated, onElementDeleted }: ProsAndConsProps) {
