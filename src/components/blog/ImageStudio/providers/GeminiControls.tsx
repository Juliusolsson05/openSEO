...
export function GeminiControls({ prompt, setPrompt, aspectRatio, setAspectRatio, onGenerate, isGenerating }: Props) {
  return (
    <div className="space-y-3 text-sm">
      ...
      <div>
        ...
        <Select value={aspectRatio} onValueChange={(value) => setAspectRatio(value as Props['aspectRatio'])}>
