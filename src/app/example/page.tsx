  ...
  return (
    <header className="fixed top-0 z-50 w-full border-b border-neutral-200/60 bg-white/80 backdrop-blur-lg">
      <div className="mx-auto flex h-14 max-w-[1120px] items-center justify-between px-6">
        <Link href="/example" className="flex items-center gap-2.5 text-[15px] font-semibold text-neutral-900 tracking-tight">
        ...
        <nav className="hidden items-center gap-1 md:flex">
          {['Features', 'Pricing', 'Customers', 'Blog'].map((item) => (
            <a
              ...
              className="rounded-md px-3 py-1.5 text-[13px] text-neutral-500 hover:text-neutral-900 hover:bg-neutral-100 transition-colors"
            >
              {item}
            </a>
          ))}
        ...
        <div className="hidden items-center gap-3 md:flex">
          ...
          <Link
            href="/login"
            className={`rounded-lg ${ACCENT.bg} ${ACCENT.bgHover} px-4 py-1.5 text-[13px] font-medium text-white transition-colors`}
          >
            Get started
          </Link>
        </div>
      ...
      {open && (
        <div className="border-t border-neutral-100 bg-white px-6 py-4 md:hidden">
          {['Features', 'Pricing', 'Customers', 'Blog'].map((item) => (
            <a key={item} href={`#${item.toLowerCase()}`} onClick={() => setOpen(false)} className="block py-2 text-sm text-neutral-600">
              {item}
            </a>
          ))}
          <Link href="/login" className={`mt-3 block rounded-lg ${ACCENT.bg} px-4 py-2 text-center text-sm font-medium text-white`}>
            Get started
          </Link>
        </div>
      )}
      ...
      <div className="mx-auto max-w-[1120px] px-6">
        <div className="max-w-2xl">
          ...
          <div className="mt-8 flex items-center gap-3">
            <Link
              href="/login"
              className={`inline-flex items-center gap-2 rounded-lg ${ACCENT.bg} ${ACCENT.bgHover} px-5 py-2.5 text-[13px] font-medium text-white transition-colors shadow-sm`}
            >
    ...
    <section id="blog" className="border-t border-neutral-100 py-20 md:py-28">
      <div className="mx-auto max-w-[1120px] px-6">
        <div className="flex items-end justify-between mb-10">
          ...
          <a href="#blog" className={`hidden md:inline-flex items-center gap-1.5 text-[13px] font-medium ${ACCENT.text} hover:underline`}>
...
function CTA() {
  return (
    <section className="border-t border-neutral-100 bg-neutral-900 py-20 md:py-24">
      <div className="mx-auto max-w-[1120px] px-6 text-center">
        <h2 className="text-[28px] font-semibold tracking-tight text-white md:text-[40px]">
          Start building today.
        </h2>
        <p className="mx-auto mt-3 max-w-md text-[15px] text-neutral-400">
          Free to start. No credit card required. Set up in under two minutes.
        </p>
        <div className="mt-8 flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
          <Link
            href="/login"
            className={`inline-flex items-center gap-2 rounded-lg ${ACCENT.bg} ${ACCENT.bgHover} px-6 py-3 text-[13px] font-medium text-white transition-colors`}
          >
            Get started for free <ArrowRight className="h-3.5 w-3.5" />
          </Link>
          <a
            href="#features"
            className="inline-flex items-center gap-2 rounded-lg border border-neutral-700 px-6 py-3 text-[13px] font-medium text-neutral-300 hover:bg-neutral-800 transition-colors"
          >
            Learn more
          </a>
        </div>
        ...
        <div className="grid gap-8 sm:grid-cols-2 md:grid-cols-4">
          <div>
            <Link href="/example" className="flex items-center gap-2 text-[14px] font-semibold text-neutral-900">
              <div className={`flex h-6 w-6 items-center justify-center rounded-md ${ACCENT.bg}`}>
          ...
          {[
            ...
            <div key={col.title}>
              ...
              <ul className="space-y-2">
                {col.links.map((link) => (
                  <li key={link}>
                    <a href="#" className="text-[13px] text-neutral-500 hover:text-neutral-900 transition-colors">
                      {link}
                    </a>
                  </li>
                ))}
