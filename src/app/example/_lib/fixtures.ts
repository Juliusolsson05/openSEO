...
export const EXAMPLE_POSTS: ExamplePost[] = [
  ...
  },
  {
    ...
    elements: [
      ...
      { id: 'p7-e4', order: 4, element_type: 'paragraph', content: { title: 'Run game days', text: 'A playbook that is never practiced is a liability. Run a monthly game day where you simulate a real incident and walk through the playbook. Fix what is confusing.' } },
      { id: 'p7-e5', order: 5, element_type: 'conclusion', content: { title: 'Conclusion', text: 'The goal is not documentation. The goal is that anyone on call at 3am can resolve an incident without guessing who to contact or what to check first.' } },
    ],
  },
  {
    id: 'post-8',
    ...
    elements: [
      ...
      { id: 'p8-e5', order: 5, element_type: 'call_to_action', content: { title: 'Deploy with confidence', text: 'Try our deployment pipeline that handles rolling and canary strategies out of the box.', button_text: 'Learn more', button_url: '#' } },
      { id: 'p8-e6', order: 6, element_type: 'conclusion', content: { title: 'Conclusion', text: 'Pick the simplest strategy that meets your uptime requirements. Rolling is enough for most teams. Graduate to canary when you need traffic-based validation.' } },
    ],
  },
  {
    id: 'post-9',
  ...
  },
  {
    ...
    elements: [
      ...
      { id: 'p10-e5', order: 5, element_type: 'quote', content: { text: 'Start with shared tables. Move to isolation when a customer contract requires it, not when an architect recommends it.', attribution: 'Engineering principle at Awesome SaaS' } },
      { id: 'p10-e6', order: 6, element_type: 'conclusion', content: { title: 'Conclusion', text: 'Shared tables with row-level security cover 90% of SaaS use cases. Reserve per-tenant isolation for compliance requirements, not theoretical security concerns.' } },
    ],
  },
]
